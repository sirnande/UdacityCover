...
<div class="container">
            ...
            <c:if test="${tipo != 3}">
                 <li><a href="#">Arquivos</a>
                    <ul class="submenu">
                        ...
                        <li><a href="Teste">Listar Arquivos</a></li>
    ...
    <div id="verde">
        <section class="galeria">
            <img class="foto" src="../media/python.jpg">
            <img class="foto" src="../media/slaide4.jpeg">
            <img class="foto" src="../media/slaide3.jpg">
            <img class="foto" src="../media/bnet-bg.jpg">
            <img class="foto" src="../media/slaide5.jpg">
        </section>
